...
#
#         Project: lcls-plc-neh-tst.tsproj
#        PLC name: neh_tst (neh_tst Instance)
# Generated using: pytmc 2.15.2.dev0+g73bd2d9.d20230727
# Project version: unknown
#    Project hash: unknown
#     PLC IP/host: 172.21.148.90
#      PLC Net ID: 172.21.148.90.1.1
...
epicsEnvSet("LOCATION", "PLC:neh_tst" )
...
epicsEnvSet("IPADDR",           "172.21.148.90")
epicsEnvSet("AMSID",            "172.21.148.90.1.1")
epicsEnvSet("AMS_PORT",         "851")
epicsEnvSet("ADS_MAX_PARAMS",   "1211")
...
system("${ADS_IOC_TOP}/scripts/add_route.sh 172.21.148.90 ^172.*$")
...
epicsEnvSet("PREFIX",         "PLC:neh_tst:")
...
epicsEnvSet("MOTOR_PREFIX",    "NEH:PPM:")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:neh_tst")
dbLoadRecords("save_restoreStatus.db", "P=PLC:neh_tst:")
dbLoadRecords("caPutLog.db", "IOC=$(IOC)")

## TwinCAT task, application, and project information databases ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:neh_tst,IDX=1")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:neh_tst")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:neh_tst,PROJECT=lcls-plc-neh-tst.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.15.2.dev0+g73bd2d9.d20230727,PLC_HOST=172.21.148.90")

#   LCLS General: * -> * (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:neh_tst,DEPENDENCY=LCLS_General,VERSION=*,VENDOR=SLAC")
#   lcls-twincat-common-components: * -> * (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:neh_tst,DEPENDENCY=lcls-twincat-common-components,VERSION=*,VENDOR=SLAC")
#   lcls-twincat-motion: * -> * (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:neh_tst,DEPENDENCY=lcls-twincat-motion,VERSION=*,VENDOR=SLAC")
#   PMPS: * -> * (SLAC - LCLS)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:neh_tst,DEPENDENCY=PMPS,VERSION=*,VENDOR=SLAC - LCLS")
#   Tc2_Standard: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:neh_tst,DEPENDENCY=Tc2_Standard,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:neh_tst,DEPENDENCY=Tc2_System,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:neh_tst,DEPENDENCY=Tc3_Module,VERSION=*,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("neh_tst.db", "PORT=$(ASYN_PORT),PREFIX=PLC:neh_tst:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 211
callbackSetQueueSize(2422)

# Autosave and archive settings:
save_restoreSet_status_prefix("PLC:neh_tst:")
